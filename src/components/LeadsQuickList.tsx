                ...
                <div className="space-y-0.5">
                  ...
                  <div className="flex items-center justify-between gap-1">
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-[11px] text-foreground truncate">{lead.name}</h4>
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[10px]">{priorityIcons[lead.priority]}</span>
                  ...
                  <div className="flex items-center justify-between gap-1">
                    <div className="flex items-center gap-1 text-muted-foreground min-w-0 flex-1">
                      <Car className="h-2 w-2 flex-shrink-0" />
                      <span className="text-[10px] truncate">{lead.vehicle}</span>
                    </div>
                    <div className="flex items-center gap-0.5 text-success font-medium">
                      <DollarSign className="h-2 w-2" />
                      <span className="text-[10px]">${(lead.value / 1000).toFixed(0)}k</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-1">
                    <div className="flex items-center gap-1 text-muted-foreground min-w-0 flex-1">
                      ...
                      <span className="text-[10px] truncate">{lead.lastActivity}</span>
                    </div>
                    {lead.journeyStage && (
                      <Badge variant="outline" className="text-[9px] px-1 py-0 h-3 bg-primary/5 text-primary border-primary/20 font-normal">
                        {lead.journeyStage}
                      </Badge>
                    )}
                  </div>
